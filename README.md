...
- Set rules at **version**, with **Up to Next Major** option and put **3.0.3** as its version
- Click next and wait
...
```swift
dependencies: [
    .package(url: "https://github.com/hainayanda/Draftsman.git", .upToNextMajor(from: "3.0.3"))
]
```
