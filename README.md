...
- Set rules at **version**, with **Up to Next Major** option and put **2.2.0** or **1.1.1** for Swift 5.1 and XCode 11 as its version
- Click next and wait
...
```swift
dependencies: [
    .package(url: "https://github.com/hainayanda/Draftsman.git", .upToNextMajor(from: "2.2.0"))
]
```
